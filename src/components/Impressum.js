...
function Impressum() {
  ...
  <p>&nbsp;</p>
  <p>
    <span style={{ textDecoration: "underline" }}>Kontaktaufnahme:</span>
  </p>
  <p>&nbsp;</p>
  <p>Telefon: 030 / 123456</p>
  <p>Fax:  030 / 123456</p>
  <p>E-Mail: grupo5@grupo5.com</p>
  <p>&nbsp;</p>
  <p>
  ...
  <p>&nbsp;</p>
  <p>
    <span style={{ textDecoration: "underline" }}>Haftung für Inhalte</span>
  </p>
  <p>
    <strong>&nbsp;</strong>
  </p>
  <p>
    ...
    bestem Gewissen erstellt. Für die Richtigkeit, Vollständigkeit und
  ...
  <p>
    ...
    Daher können wir für die „externen Links“ auch keine Gewähr auf Richtigkeit
    der Inhalte übernehmen. Für die Inhalte der externen Links sind die
  ...
  <p>
    ...
    rechtswidrigen Inhalten. Eine ständige inhaltliche Überprüfung der externen
    Links ist ohne konkrete Anhaltspunkte einer Rechtsverletzung nicht möglich.
    Bei direkten oder indirekten Verlinkungen auf die Webseiten Dritter, die
    außerhalb unseres Verantwortungsbereichs liegen, würde eine
    Haftungsverpflichtung ausschließlich in dem Fall nur bestehen, wenn wir von
    den Inhalten Kenntnis erlangen und es uns technisch möglich und zumutbar
  ...
  <p>
    ...
    Internetauftrittes „<em>Name Ihrer Domain</em>“ gesetzten Links und Verweise
    ...
    Informationen entstehen, haftet allein der Diensteanbieter der Seite, auf
  ...
  <p>&nbsp;</p>
  <p>
    <span style={{ textDecoration: "underline" }}>Urheberrecht</span>
  </p>
  <p>
    <strong>&nbsp;</strong>
  </p>
  <p>
    ...
    Urhebers außerhalb der Grenzen des Urheberrechtes bedürfen der vorherigen
    ...
    kommerziellen Gebrauch erlaubt. Sind die Inhalte auf unserer Webseite nicht
    von uns erstellt wurden, sind die Urheberrechte Dritter zu beachten. Die
    Inhalte Dritter werden als solche kenntlich gemacht. Sollten Sie trotzdem
  ...
  <p>
    Dieses <a href="http://www.jurarat.de/muster-impressum">Impressum</a> wurde
